...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Head pose estimation using the Vendnet network.')
...
if __name__ == '__main__':
    ...
    # ResNet50 structure
    model = vendnet.Vendnet(torchvision.models.resnet.Bottleneck, [3, 4, 6, 3], 66)
